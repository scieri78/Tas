...
?>
<div style="width: 145px; height: 30px;  border: 1px solid black; bachground: white; text-align: center; margin: 5px;  cursor: pointer; padding: 7px;" onclick="$('#MostraStorico').empty().hide()" >CHIUDI</div><BR>
<CENTER><b style="font-size:20px" >STORICO ULTIMI 60 GIORNI</b></CENTER>
