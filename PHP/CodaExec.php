...
<table class="Exceltable" style="border:3px solid white;">
...
//if ( $find = 1 )  {
                  ...
                  if ( $SonDepEnable == 'Y' ){
                    ...
                    while ($rowCnt = db2_fetch_assoc($stmtCnt)) {
                      ...
                      $stmt2 = db2_prepare($conn, $Sql2);
                       ...
                       if ( ! $result ){
                         echo "ERROR DB2 Em Group Sons:".db2_stmt_errormsg();
                       }
              ...
              if ( "$Enable" == "Y" ){
                    ...
                    while ($rowCnt = db2_fetch_assoc($stmtCnt)) {
                      ...
                      $stmt2 = db2_prepare($conn, $Sql2);
                       ...
                       $result=db2_execute($stmt2);
                       if ( ! $result ){
                         echo "ERROR DB2 Em Group Father:".db2_stmt_errormsg();
                       }
          ...
          if ( $DepEnable == 'Y' ){
            ...
            while ($rowCnt = db2_fetch_assoc($stmtCnt)) {
                ...
                $stmt2 = db2_prepare($conn, $Sql2);
                 ...
                 $result=db2_execute($stmt2);
                 if ( ! $result ){
                   echo "ERROR DB2 Em Group Son".db2_stmt_errormsg();
                 }
    ...
    ?>
    <tr><th colspan=2 >Totale <B><?php echo $TotCnt; ?></B> lanci in attesa</th><th><?php if ( "$SelIdEmGroup" != "" and "$SaveTime" != "0"  ) { ?>Prec.<?php echo gmdate('H:i:s', $SaveTime); } ?></th><th>Tot.<?php echo gmdate('H:i:s', $SumTime); ?></th></tr>
    </table>
    <?php   
