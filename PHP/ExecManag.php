...
<tr>
  ...
  <td><div class="Button" style="background-color:yellow;padding-top: 5px;" id="ForceRun" >Force Run</div></td>
  ...
  <td><input class="Button" style="background-color:yellow;" type="submit" value="REFRESH"   onclick="Refresh()" ></td>
  
  <td><div id="ViewLog" style="z-index:999;" >
  <img class="ObjectImg" src="../images/Log.png" style="width:30px;background:white;" onclick="OpenFile('/area_staging_TAS/DIR_LOG/ExecManag/ExecManag_Group_<?php echo $DATABASE.'_'.date('Ym'); ?>.log','LSH')" >
  </div></td>
  <?php } ?>
                    ...
                    <td>
                      ...
                      <tr>
                           <th rowspan=2 >
                            ...
                            <?php } ?>
                            <td>
                                  <?php if ( "$SonIdRunSh" != "" ) { ?><img class="ObjectImg" src="../images/LogProc.png"    onclick="OpenLink(<?php echo $SonIdRunSh; ?>)" ><?php } ?>
								  <?php if ( "$SonRemIdRunSh" != "" and "$SonIdRunSh" == "" ) { ?><img class="ObjectImg" src="../images/LogProc.png"    onclick="OpenRemLink(<?php echo $SonRemIdRunSh; ?>)" ><?php } ?>
                            </td>
							<td rowspan=2>
							<?php
							if ( "$SonDepBg" == "Y" ){
          ...
          <div class="Object Div<?php echo $IdObject ?>" >
            ...
            <td>
               ...
               <tr>
                    ...
                    <?php } ?>
                    <td>
                        <?php if ( "$IdRunSh" != "" ) { ?><img class="ObjectImg" src="../images/LogProc.png"    onclick="OpenLink(<?php echo $IdRunSh; ?>)" ><?php } ?>
						<?php if ( "$RemIdRunSh" != "" and "$IdRunSh" == "" ) { ?><img class="ObjectImg" src="../images/LogProc.png"    onclick="OpenRemLink(<?php echo $RemIdRunSh; ?>)" ><?php } ?>
                    </td>
					<td rowspan=2>
					<?php
					if ( "$Bg" == "Y" ){
              ...
              <div class="Object Div<?php echo $IdObjectDep ?>" >
                ...
                <td>
                  ...
                  <tr>
                       ...
                       <?php } ?>
                       <td >
                           <?php if ( "$DepIdRunSh" != "" ) { ?><img class="ObjectImg" src="../images/LogProc.png"    onclick="OpenLink(<?php echo $DepIdRunSh; ?>)" ><?php } ?>
						   <?php if ( "$DepRemIdRunSh" != "" and "$DepIdRunSh" == "" ) { ?><img class="ObjectImg" src="../images/LogProc.png"    onclick="OpenRemLink(<?php echo $DepRemIdRunSh; ?>)" ><?php } ?>
                       </td>
						<td rowspan=2>
						<?php
						if ( "$DepBg" == "Y" ){
...
<div id="ShowCodaExec" ><input id="ShowCoda" class="Button" id="Refresh" value="IN CODA" onclick="OpenCoda()" readonly  ></div>
</form>
<script>
...
function OpenCoda(){
	if ( $('#DivCodaExec').css('display') == 'none' ){
	  $('#DivCodaExec').empty().load('../PHP/CodaExec.php',{'SelIdEmGroup':'<?php echo $IdEmGroup; ?>'});
	  $('#DivCodaExec').show();
	} else {
	  $('#DivCodaExec').hide();
	}
...
function OpenLink(vIdRunSh){
    window.open('../PAGE/PgStatoShell.php?IDSELEM='+vIdRunSh);
}

function OpenRemLink(vIdRunSh){
    window.open('../../<?php echo $RemDir; ?>/PAGE/PgStatoShell.php?IDSELEM='+vIdRunSh);
}
...
function OpenExecManagGroup(){
      $('#FormScheduler').attr('action','../PAGE/PgExecManagGroup.php');
      $('#FormScheduler').submit();     
}
