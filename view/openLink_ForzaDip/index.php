...
<table id="idTabedlla" class="display dataTable">
  ...
  ?>
    <tr onclick="$('#Dett<?php echo $IdLegame; ?>').toggle()" class="<?php if ("$Tipo" != "F") { ?>Dipendenza<?php }  echo $Blocca; ?>">
      ...
      <td style="width:10px;" ><?php echo $Prio; ?></td>
      ...
      <td colspan=5 style="text-align: center;background:#eff4ff;">
        ...
        switch ($Tipo) {
          ...
          ?>
            ...
            <div onclick="ActionF('Carica','',<?php echo $IdLegame; ?>,'<?php echo $IdDip; ?>','<?php echo $DipName; ?>','<?php echo $Tipo; ?>','<?php echo $NomeFlusso; ?>')" class="btn">
                      <i class="fa-solid fa-upload"> </i> Load</div>
          <?php
            break;
          case "E":
          ?>
          <div onclick="ActionF('Elabora','Confermi di voler forzare l elaborazione di questo passo?',<?php echo $IdLegame; ?>,'<?php echo $IdDip; ?>','<?php echo $DipName; ?>','<?php echo $Tipo; ?>','<?php echo $NomeFlusso; ?>')" class="btn">
          <i class="fa-solid fa-play"></i> Avvia Elaborazione</div>
          <?php
            break;
        }
        //}
