...
<link rel="stylesheet" href="./CSS/WorkFlow.css?p=<?php echo rand(1000,9999);?>">
<?php
...
//==========   FORM
    ...
    <div id="ListWfs">
      ...
      <select id="IdWorkFlow" name="IdWorkFlow" style="width:100%;color:black; box-shadow: -3px 2px 2px 0px lightgray !important; -o-box-shadow: -3px 2px 2px 0px lightgray !important; -moz-box-shadow: -3px 2px 2px 0px lightgray !important;"  >
           <option value="" >..</option>
           <?php           
      ...
      <select id="IdPeriod" name="IdPeriod" style="width:100%;color:black;box-shadow: -3px 2px 2px 0px lightgray !important; -o-box-shadow: -3px 2px 2px 0px lightgray !important; -moz-box-shadow: -3px 2px 2px 0px lightgray !important;"  >
           <option value="" >..</option>
           <?php           
      ...
      <tr>
      <td>
      <select id="IdProcess" name="IdProcess" style="width:100%;color:black;box-shadow: -3px 2px 2px 0px lightgray !important; -o-box-shadow: -3px 2px 2px 0px lightgray !important; -moz-box-shadow: -3px 2px 2px 0px lightgray !important;"  >
           <option value="" >..</option>
           <?php           
  ...
  ?>
      ...
      <script>
        ...
        if ( vId != '' ){
            $('#ShowDettFlusso').empty().load('./index.php?controller=workflow&action=LoadFlusso',{
            ...
            $('#ShowDettFlusso').empty().load('./index.php?controller=workflow&action=Legend');
        }
                         ...
                         if ( "$IdFlu" != "$OldIdFlu"){
                           ...
                           foreach( $ArrFlussi as $Flusso ){
                             ...
                             if ( "$IdFlusso" == "$IdFlu" ){ 
                                ...
                                <script>
                                 $('#StatusFlusso<?php echo $IdFlusso; ?>').load('./index.php?controller=workflow&action=Flusso',{
                                           IdWorkFlow: '<?php echo $IdWorkFlow; ?>',
                                           IdProcess: '<?php echo $IdProcess; ?>',
    ...
    <script>
        ...
        $( "#RefreshCoda" ).load('./index.php?controller=workflow&action=RefreshCoda',{
            IdWorkFlow : <?php echo $IdWorkFlow          ; ?>,
            IdProcess  : <?php echo $IdProcess           ; ?>,
...
//==========   SCRIPT
    ...
    <script>
      ...
      function ReOpenDettFlusso(vIdWorkFlow,vIdProcess,vIdFlusso,vNomeFlusso,vDescFlusso){
          ...
          $('#StatusFlusso'+vIdFlusso).load('./index.php?controller=workflow&action=Flusso',{
    ...
    <script>   
      ...
      function LoadDiv(){
            ...
            if ( $( "#MostraCoda" ).text() != "" ){
              $( "#MostraCoda" ).load('./index.php?controller=workflow&action=MostraCoda',{
                IdWorkFlow : '<?php echo $IdWorkFlow; ?>',
                IdProcess  : '<?php echo $IdProcess; ?>'
              });   
            }
     ...
     setInterval(function(){ LoadDiv(); }, 5000); 
      ...
      $('#PulMostraCoda').click(function(){
           $( "#MostraCoda" ).empty().load('./index.php?controller=workflow&action=MostraCoda',{
                IdWorkFlow : '<?php echo $IdWorkFlow; ?>',
                IdProcess  : '<?php echo $IdProcess; ?>'
            }).show();
      });
      ...
      $('#PulMostraStorico').click(function(){
           $( "#MostraStorico" ).empty().load('./index.php?controller=workflow&action=MostraStorico',{
                IdWorkFlow : '<?php echo $IdWorkFlow; ?>',
                IdProcess  : '<?php echo $IdProcess; ?>'
            }).show();
      });   
    ...
    function OpenDiagram(){
        $( "#ShowDiagram" ).load('./index.php?controller=workflow&action=GeneraDiagram',{
                IdWorkFlow : '<?php echo $IdWorkFlow; ?>',
                IdProcess  : '<?php echo $IdProcess; ?>',
