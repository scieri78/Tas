        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="index.php?controller=<?php echo $_GET['controller']?>&action=insert" method="post" >
                        ...
                        <a href="index.php?controller=<?php echo $_GET['controller']?>" class="btn btn-default">Cancel</a>
                    </form>
                </div>
            </div>        
        </div>
