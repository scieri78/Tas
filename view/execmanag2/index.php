 <div class="breadcrumbs">Old Site | 
 	  <span>Execution Manager Groups</span>
</div>
 <style>
...
if ( "$AddGroup" == "" and "$EditGroup" == "" ){
   ...
   <input type="checkbox" name="EnableRefresh"  id="EnableRefresh" value="1" <?php if ( "$EnableRefresh" == "1" ) { ?>checked<?php } ?> title="AutoRefresh" ></td>
   <td>
...
function OpenGroup(vIdEmGroup,vNameGroup){
      ...
      $('#FormScheduler').attr('action','./index.php?controller=execmanag&action=ExecManag')
