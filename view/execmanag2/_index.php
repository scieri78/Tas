<div class="breadcrumbs">New Site2 | <span>Execution Manager Groups</span>
</div>
<style>
   ...
   WHERE 1=1
    ...
    if ( ! $results ){
        ...
        ?><table class="ExcelTable">
            ...
            <?php
            foreach ($datiExecManagGroups as $rows) {
...
//echo $sqlListGroup;
    ...
    */
    ...
    ?><ul><?php
          foreach ($DepAll as $row) {
            $Priority = $row['PRIORITY'];
            echo $IdEmGroup = $row['ID_EM_GROUP'];
          ...
          ?></ul>
              ...
              $GroupsLinks =  $excmanModel->getExecManagGroupsLink($IdEmGroup);
            ...
            $FindLinks=0;
            $Arr_Links=array();*/
              foreach ($GroupsLinks as $rowLink) {
                $IdLink = $rowLink['ID_EM_GROUP_LINK'];
                array_push($Arr_Links, $IdLink);
                $FindLinks = 1;
              }
              ...
              $GroupsObjects =  $excmanModel->getExecManagGroupsObjects($IdEmGroup);
  ...
  <li <?php echo $lidisable; ?>>
    ...
    <?php
          ...
          <?php
              $excmanModel->Sons($IdEmGroupDep, $conn, $Arr_Groups);
