                      ...
                      ?><img class="FolderImg" src="./images/StatusI.png"><?php
                                                                          ...
                                                                          if ("$SonDepStatus" != "I") {
                                                                            ?><img class="FolderImg" src="./images/Status<?php echo "$SonDepStatus"; ?>.png"><?php
                                                                              ...
                                                                              ?>
                      <div class="GroupNameGroup" onclick="OpenGroup(<?php echo $SonIdEmGroupDep; ?>,'<?php echo $SonDepNameGroup; ?>')" title="<?php echo $SonIdEmGroupDep; ?>">
                        <?php echo "$SonDepNameGroup [${CntDep}${DescNotEnable}]"; ?></div>
                    </td>
                  </tr>
                  <tr>
                    <td>
