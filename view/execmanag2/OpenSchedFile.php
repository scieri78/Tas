...
<form id="FormFile" method="POST">
  <div id="divDownload" >
<button onclick="window.open('./TMP/<?php echo $filename;?>');return false;" id="removeWorkFlow" class="btn" style="display: inline-block;"><i class="fa-solid fa-download"> </i> Download File</button>
