...
<?php 
  ...
  if ( "$ForceRun" == "Force Run" ){	  
	  ...
	  ?><script>alert('Force Run Done!');</script><?php
  }
...
<div class="Titolo" ><CENTER>Execution Management <?php echo $NameGroup; ?></CENTER></div>
...
<tr>
  ...
  <td><div id="ViewLog"  >
    <?php 
    $logFile = "Log: /area_staging_TAS/DIR_LOG/ExecManag/ExecManag_Group_".$DATABASE."_".date('Ym').".log";
    ?>
  <img class="ObjectImg" src="./images/Log.png" onclick="OpenFile('/area_staging_TAS/DIR_LOG/ExecManag/ExecManag_Group_<?php echo $DATABASE.'_'.date('Ym'); ?>.log','LSH','<?= $logFile ?>')" >
  </div></td>
  <?php } ?>
...
<?php
    ...
    if ( "$DeleteObject" != "" ){
          ...
          $Sql='CALL WORK_CORE.K_EXEC_MANAG.DeleteObject(?, ?)';
          ...
          $result=db2_execute($stmt);
          if ( ! $result ){
            echo "ERROR DB2 Delete Object:".db2_stmt_errormsg($stmt);
          }
    ...
    if ( "$SaveNew" != "" ){
          ...
          $Sql='CALL WORK_CORE.K_EXEC_MANAG.SaveNew(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
          $stmt = db2_prepare($conn, $Sql);
    ...
    if ( "$SaveEdit" != "" ){
          ...
          $Sql='CALL WORK_CORE.K_EXEC_MANAG.SaveEdit(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
          $stmt = db2_prepare($conn, $Sql);
          ...
          $result=db2_execute($stmt);
          if ( ! $result ){
            echo "ERROR DB2 Save <B>Edit:</B> ".db2_stmt_errormsg();
          }
    ...
    if ( "$ChangeStatus" != "" ){
        ...
        $Sql='CALL WORK_CORE.K_EXEC_MANAG.ChangeStatus(?, ?, ?)';
        $stmt = db2_prepare($conn, $Sql);
    ...
    if ( "$ChangePriority" != "" ){
          ...
          $Sql='CALL WORK_CORE.K_EXEC_MANAG.ChangePriority(?, ?, ?)';
          $stmt = db2_prepare($conn, $Sql);
    ...
    if ( "$EditObject" != "" ){
       ...
       <div id="EditDiv" class="centerDiv" >
            ...
            <table class="center">
              ...
              <tr><th>Group</th><td><select name="SelIdEmGroup" id="SelIdEmGroup" >
                <?php
              ...
              <tr><th>Target Dir</th><td><input type="text" name="SelTargetDir" id="SelTargetDir" value="<?php echo "$SelTargetDir"; ?>" required ></td></tr>
              <tr><th>Target</th><td><input type="text" name="SelTarget" id="SelTarget" value="<?php echo "$SelTarget"; ?>" required ></td></tr>
              <tr><th>Variables</th><td><input type="text" name="SelVariables" id="SelVariables" value='<?php echo "${SelVariables}"; ?>' ></td></tr>
              <tr><th>Enable</th><td>
              ...
              <tr><th>SetMonth</th><td><input type="text" name="SelSetMonth" id="SelSetMonth" value="<?php echo "$SelSetMonth"; ?>" ></td></tr>
              <tr><th>SetDay</th><td><input type="text" name="SelSetDay" id="SelSetDay" value="<?php echo "$SelSetDay"; ?>" ></td></tr>
              <tr><th>SetHour</th><td><input type="text" name="SelSetHour" id="SelSetHour" value="<?php echo "$SelSetHour"; ?>" ></td></tr>
              <tr><th>SetMinute</th><td><input type="text" name="SelSetMinute" id="SelSetMinute" value="<?php echo "$SelSetMinute"; ?>" ></td></tr>
              ...
              <select name="SelBg" id="SelBg" >
               ...
               <table class="center">             
                ...
                <?php
				$List=explode(',',ListSons($EditObject));
                foreach( $Arr_Objects as $Object2 ){
                  $ObjId=$Object2[0];
				  $ObjDesc=$Object2[1];
                  $ObjTarget=$Object2[3];
              ...
              <td colspan=2 >
                ...
                foreach( $Arr_Objects as $Object2 ){
                  ...
                  $SelGroup=$Object2[20];
                  $Checked="";
                  if ( in_array( $ObjId, $Arr_Links ) ){ $Checked="Checked"; }
                  if ( "$ObjId" != "$EditObject" ){
				     if ( ! in_array($ObjId, $List ) ){
                        ?>
                        <tr>
           ...
           <div id="NewDiv" class="centerDiv" >
                ...
                <table class="center">
                  ...
                  <tr><td colspan=2 ><select name="SelFather" id="SelFather" >
                    ...
                    <?php
				    $List=explode(',',ListSons($AddObject));
                    foreach( $Arr_Objects as $Object2 ){
                      $ObjId=$Object2[0];
					  $ObjDesc=$Object2[1];
                      $ObjTarget=$Object2[3];
                      ...
                      $SelGroup=$Object2[20];
					  $Selected="";
					  if ( "$ObjId" == "$AddObject" ){ $Selected="selected"; }
				      if ( ! in_array($ObjId, $List ) ){
                    ...
                    <td>
                      ...
                      <tr>
                           <th rowspan=2 >
                            ...
                            <tr><td  style="width:300px !important" >
                            <?php
                            if ( "$SonDepStatus" == "Y" ){
                            ...
                            <div class="ObjectTarget" onclick="OpenFile(<?php echo $SonIdObjectDep; ?>,'S','File: <?=$SonDepTarget  ?>')"  title="<?php echo $SonIdObjectDep; ?>" ><?php echo $SonDepTarget; 
							if ( $SonRemIdRunSh != "" and $SonIdRunSh == "" ){ echo $RemLabel; }
							?></div>
                            </td><tr>
                            <tr><td><div class="ObjectVaraibles" ><?php echo "$SonDepVariables"; ?></div></td><tr>
                            <tr><td><div class="ObjectTargetDir" ><?php echo "$SonDepTargetDir"; ?></div></td><tr>
                            <tr><td><div class="ObjectTargetDir" ><B>Creator:</B> <?php echo "$SonDepCreator - $TimeCreator"; ?></div></td><tr>
						    <tr><td><div class="ObjectTargetDir" ><B>Editor:</B> <?php echo "$Editor - $TimeEditor"; ?></div></td></tr>
                            ...
                            <?php } ?>
                            <td>
                                  <?php if ( "$SonIdRunSh" != "" ) { ?><img class="ObjectImg" src="./images/Shell.png"    onclick="OpenLink(<?php echo $SonIdRunSh; ?>,'user','<?php echo $SonDepTarget; ?>')" ><?php } ?>
								  <?php if ( "$SonRemIdRunSh" != "" and "$SonIdRunSh" == "" ) { ?><img class="ObjectImg" src="./images/Shell.png" onclick="OpenLink(<?php echo $SonRemIdRunSh; ?>,'work','<?php echo $SonDepTarget; ?>')" ><?php } ?>
                            </td>
							<td rowspan=2>
							<?php
							if ( "$SonDepBg" == "Y" ){
                      ...
                      <tr>
                             ...
                             <td >
                                <?php if ( "$SonDepLogSh" != "" ) { ?><img class="ObjectImg" src="./images/Log.png"    onclick="OpenFile('<?php echo $SonDepLogSh; ?>','LSH','File: <?=  $SonDepDescrObject; ?>')" ><?php } ?>
								<?php if ( "$SonDepRemLogSh" != "" and "$SonDepLogSh" == "" ) { ?><img class="ObjectImg" src="./images/Log.png"    onclick="OpenFile('<?php echo $SonDepRemLogSh; ?>','LSH','File: <?=  $SonDepDescrObject; ?>')" ><?php } ?>
                             </td>	
							 <?php } ?>
							...
							<td style="width:200px !important" ><?php echo "$SonDepDescrObject"; ?></td>
							 ...
							 <td style="width:45px !important" ><?php if ( "$SonTime" != "0" and "$SonTime" != "" ) { echo floor(($SonTime-1)/(60*60*24))."g ".gmdate('H:i:s', $SonTime); } ?></td>
							 <td style="width:45px !important" ><?php if ( "$SonOldTime" != "0" and "$SonOldTime" != "" ) { echo floor(($SonOldTime-1)/(60*60*24))."g ".gmdate('H:i:s', $SonOldTime); } ?></td>
            ...
            <td>
               ...
               <tr>
                    <th rowspan=2 >
                     ...
                     <div class="ObjectTarget"  onclick="OpenFile(<?php echo $IdObject; ?>,'S','File: <?= $Target ?>')"  title="<?php echo $IdObject; ?>" ><?php echo $Target; 
					 if ( "$RemIdRunSh" != "" and "$IdRunSh" == ""  ) { echo $RemLabel; }
					 ?></div>
                     </td></tr>
                     <tr><td><div class="ObjectVaraibles" ><?php echo "$Variables"; ?></div></td></tr>
                     <tr><td><div class="ObjectTargetDir" ><?php echo "$TargetDir"; ?></div></td></tr>
                     <tr><td><div class="ObjectTargetDir" ><B>Creator:</B> <?php echo "$CreatorObject - $TimeCreator"; ?></div></td></tr>
				     <tr><td><div class="ObjectTargetDir" ><B>Editor:</B> <?php echo "$Editor - $TimeEditor"; ?></div></td></tr>
					 <tr><td><div class="GroupNameGroupDir" ><B>Executor:</B> <?php echo "$Executor - $TimeExecutor"; ?></div></td></tr>
                     </table>
                    </th>
                    ...
                    <?php } ?>
                    <td>
                        <?php if ( "$IdRunSh" != "" ) { ?><img class="ObjectImg" src="./images/Shell.png"    onclick="OpenLink(<?php echo $IdRunSh; ?>,'user','<?php echo $Target; ?>')" ><?php } ?>
						<?php if ( "$RemIdRunSh" != "" and "$IdRunSh" == "" ) { ?><img class="ObjectImg" src="./images/Shell.png"    onclick="OpenLink(<?php echo $RemIdRunSh; ?>,'work','<?php echo $Target; ?>')" ><?php } ?>
                    </td>
					<td rowspan=2>
					<?php
					if ( "$Bg" == "Y" ){
               ...
               <tr>
					 ...
					 <td >
                         <?php if ( "$LogSh" != "" ) { ?><img class="ObjectImg" src="./images/Log.png"    onclick="OpenFile('<?=  $LogSh ?>','LSH','Log: <?= $LogSh ?>')" ><?php } ?>
						 <?php if ( "$RemLogSh" != "" and "$LogSh" == "" ) { ?><img class="ObjectImg" src="./images/Log.png"    onclick="OpenFile('<?= $RemLogSh ?>','LSH','Log: <?= $RemLogSh ?>')" ><?php } ?>
                     </td>					 
                     <?php } ?>
                    <th style="width:30px !important" >Descr</th>   
                    <td style="width:200px !important"><?php echo "$DescrObject"; ?></td>  
					 ...
					 <td style="width:45px !important" ><?php  if ( "$Time" != "0" and "$Time" != "" ) {  echo floor(($Time-1)/(60*60*24))."g ".gmdate('H:i:s', $Time); } ?></td>
					 <td style="width:45px !important" ><?php if ( "$OldTime" != "0" and "$OldTime" != "" ) {  echo floor(($OldTime-1)/(60*60*24))."g ".gmdate('H:i:s', $OldTime); } ?></td>
                ...
                <td>
                  ...
                  <tr>
                       ...
                       <tr><td style="width:300px !important">
                        ...
                        ?>                     
                       <div class="ObjectTarget"  onclick="OpenFile(<?php echo $IdObjectDep; ?>,'S','File:<?= $DepTarget ?>')" title="<?php echo $IdObjectDep; ?>" >
                        <?php echo $DepTarget; 
					   if (  $DepRemIdRunSh != "" and $DepIdRunSh == "" ) { echo $RemLabel; }
					   ?></div>
                        </td></tr>
                        <tr><td><div class="ObjectVaraibles" ><?php echo "$DepVariables"; ?></div></td></tr>
                        <tr><td><div class="ObjectTargetDir"    ><?php echo "$DepTargetDir"; ?></div></td></tr>
                        <tr><td><div class="ObjectTargetDir" ><B>Creator:</B> <?php echo "$DepCreatorObject - $TimeCreator"; ?></div></td></tr>
						<tr><td><div class="ObjectTargetDir" ><B>Editor:</B> <?php echo "$Editor - $TimeEditor"; ?></div></td></tr>
					    <tr><td><div class="GroupNameGroupDir" ><B>Executor:</B> <?php echo "$Executor - $TimeExecutor"; ?></div></td></tr>
                        </table>
                       </th>
                  ...
                  <tr>
						...
						<td >
                         <?php if ( "$DepLogSh" != "" ) { ?><img class="ObjectImg" src="./images/Log.png" onclick="OpenFile('<?php echo $DepLogSh; ?>','LSH','File: <?= $DepDescrObject  ?>')" ><?php } ?>
						 <?php if ( "$DepRemLogSh" != "" and "$DepLogSh" == "" ) { ?><img class="ObjectImg" src="./images/Log.png" onclick="OpenFile('<?php echo $DepRemLogSh; ?>','LSH','File: <?= $DepDescrObject  ?>)" ><?php } ?>
                        </td>
                        <?php } ?>	
                       <th style="width:30px !important"  >Descr</th> 
                       <td style="width:200px !important" ><?= $DepDescrObject ?></td>  
                        <th>End Time</th>
                        <td width="145px" ><?php echo "$DepEndTime"; ?></td>
					    <td style="width:45px !important" ><?php if ( $DepTime != "0" and $DepTime != "" ) { echo floor(($DepTime-1)/(60*60*24))."g ".gmdate('H:i:s', $DepTime); } ?></td>
						<td style="width:45px !important" ><?php if ( $DepOldTime != "0"  and $DepOldTime != "" ) { echo floor(($DepOldTime-1)/(60*60*24))."g ".gmdate('H:i:s', $DepOldTime); } ?></td>
...
function OpenCoda(IdEmGroup){
		...
		$.ajax({
          ...
          // specifico la URL della risorsa da contattare
			...
			url: 'index.php?controller=execmanag&action=codaexec&SelIdEmGroup='+IdEmGroup,
...
function OpenFile(vIdObject,vType,SHFILE){
	$.ajax({
          method: "get",	  
           
          // specifico la URL della risorsa da contattare
            url: 'index.php?controller=execmanag&action=openschedfile&IDOBJ='+vIdObject+'&TYPE='+vType,   
          // imposto l'azione in caso di successo
          success: function(risposta){
...
function OpenLink2(vIdRunSh,db_name,titoloSh){
	...
	$.ajax({
          ...
          //visualizzo il contenuto del file nel div htmlm
			...
			$("#SHdialog").dialog({title: titoloSh+" ( "+db_name+" )"});
...
function OpenExecManagGroup(){
      $('#FormScheduler').attr('action','index.php?sito='+getParameterByName('sito')+'&controller=execmanag&action=index');
      $('#FormScheduler').submit();     
}
