                    ...
                    <td>
                      ...
                      <tr>
                           <th rowspan=2 >
                            ...
                            <div class="ObjectTarget" onclick="OpenFile(<?php echo $SonIdObjectDep; ?>,'S')"  title="<?php echo $SonIdObjectDep; ?>" >2<?php echo $SonDepTarget; 
                      ...
                      <tr>
                             ...
                             <td >
                                <?php if ( "$SonDepLogSh" != "" ) { ?>3<img class="ObjectImg" src="./images/Log.png"    onclick="OpenFile('<?php echo $SonDepLogSh; ?>','LSH')" ><?php } ?>
								<?php if ( "$SonDepRemLogSh" != "" and "$SonDepLogSh" == "" ) { ?>4<img class="ObjectImg" src="./images/Log.png"    onclick="OpenFile('<?php echo $SonDepRemLogSh; ?>','LSH')" ><?php } ?>
                             </td>	
							 <?php } ?>
            ...
            <td>
               ...
               <tr>
                    <th rowspan=2 >
                     ...
                     5<div class="ObjectTarget"  onclick="openDialog(<?php echo $IdRunSh; ?>,'<?php echo $Target; ?>','apriFile')"  title="<?php echo $IdObject; ?>" ><?php echo $Target; 
               ...
               <tr>
					 ...
					 <td >
                         <?php if ( "$LogSh" != "" ) { ?>6<img class="ObjectImg" src="./images/Log.png"    onclick="OpenFile('<?php echo $LogSh; ?>','LSH')" ><?php } ?>
						 <?php if ( "$RemLogSh" != "" and "$LogSh" == "" ) { ?>7<img class="ObjectImg" src="./images/Log.png"    onclick="OpenFile('<?php echo $RemLogSh; ?>','LSH')" ><?php } ?>
                     </td>					 
                     <?php } ?>
                    <th style="width:30px !important" >Descr</th>   
                ...
                <td>
                  ...
                  <tr>
                       ...
                       <tr><td style="width:300px !important">
                        ...
                        ?>                     
                       8<div class="ObjectTarget"  onclick="OpenFile(<?php echo $IdObjectDep; ?>,'S')" title="<?php echo $IdObjectDep; ?>" ><?php echo "$DepTarget"; 
                  ...
                  <tr>
						...
						<td >
                         <?php if ( "$DepLogSh" != "" ) { ?>9<img class="ObjectImg" src="./images/Log.png"    onclick="OpenFile('<?php echo $DepLogSh; ?>','LSH')" ><?php } ?>
						 <?php if ( "$DepRemLogSh" != "" and "$DepLogSh" == "" ) { ?>10<img class="ObjectImg" src="./images/Log.png"    onclick="OpenFile('<?php echo $DepRemLogSh; ?>','LSH')" ><?php } ?>
                        </td>
                        <?php } ?>	
                       <th style="width:30px !important"  >Descr</th> 
