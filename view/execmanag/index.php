 <div class="breadcrumbs"><span>Execution Manager Groups</span>
 </div>
 <style>
   ...
   <?php
    ...
    ?>
     ...
     <div id="FindDiv" <?php if ("$Ricerca" != "Ricerca") { ?> hidden <?php } ?>>
       <CENTER><BR>
         <input type="text" name="Search" id="Search" style="width:40%;" value="<?php if ("$Ricerca" != "Ricerca") {
                                                                                  echo $Ricera;
                                                                                } ?>">
         ...
         <?php
          ...
          ?>
           <td>
             ...
             <input type="checkbox" name="EnableRefresh" id="EnableRefresh" value="1" <?php if ("$EnableRefresh" == "1") { ?>checked<?php } ?> title="AutoRefresh">
           </td>
           <td>
    ...
    ORDER BY NAME_GROUP";
      ...
      ?><div id="InRun">
       ...
       <div id="EditDiv" class="centerDiv">
             ...
             <tr>
               <td colspan=2><select name="SelFather" id="SelFather">
                   ...
                   <?php
                    ...
                    ?><option value="<?php echo $IdEmGroup2; ?>" <?php if ("$SelIdFather" == "$IdEmGroup2") { ?> selected <?php } ?>><?php echo $NameGroup2;
                                                                                                                                          if ("$DescrGroup2" != "") {
                                                                                                                                            echo " ( $DescrGroup2 )";
                                                                                                                                          } ?></option><?php
                                                                                                                                                                                                                                    }
         ...
         <center>
           <input class="Button" type="submit" id="SaveEdit" name="SaveEdit" value="Save" onclick="return validatorGruop()">
     ...
     <?php
      ...
      ?>
       <div id="NewDiv" class="centerDiv">
                   ...
                   <select name="SelFather" id="SelFather">
                     ...
                     <?php
                      foreach ($Arr_Groups as $Group2) {
                        ...
                        $Enable2   = $Group2[2];
                        $DescrGroup2  = $Group2[12];
                      ?><option value="<?php echo $IdEmGroup2; ?>" <?php if ("$AddGroup" == "$IdEmGroup2") { ?> selected <?php } ?>><?php echo $NameGroup2;
                                                                                                                                      if ("$DescrGroup2" != "") {
                                                                                                                                        echo " ( $DescrGroup2 )";
                                                                                                                                      } ?></option><?php
                                                                                                                                                                                                                                }
         ...
         <center>
           <input class="Button" type="submit" id="SaveNew" name="SaveNew" value="Save" onclick="return validatorGruop()">
             ...
             <td>
               <table class="ExcelTable">
                 <tr>
                   <th rowspan=2 style="background:white;">
                     <table class="TitShell">
                       ...
                       <tr>
                         <td>
                           <div class="GroupNameGroupDir"><B>Creator:</B> <?php echo "$SonDepCreator - $TimeCreator"; ?></div>
                         </td>
                       </tr>
                       <tr>
                         <td>
                           <div class="GroupNameGroupDir"><B>Editor:</B> <?php echo "$Editor - $TimeEditor"; ?></div>
                         </td>
                       </tr>
                       <tr>
                         <td>
                 ...
                 <tr>
                   ...
                   <?php } ?>
                   <td>
                     <div width="100px"><?php echo "$SonDepDescrGroup"; ?></div>
                   </td>
                   <th>End Time</th>
                   <td width="100px"><?php echo "$SonDepEndTime"; ?></td>
                   <td style="min-width:100px !important"><?php if ("$TrueTime" != "0" and "$TrueTime" != "") {
                                                            echo  floor(($TrueTime - 1) / (60 * 60 * 24)) . "g " . gmdate('H:i:s', $TrueTime);
                                                          } ?></td>
    ...
    ORDER BY PRIORITY,ID_EM_GROUP,PRIORITY_DEP,ID_EM_GROUP_DEP";
      ...
      ?><ul><?php
          ...
          ?></ul>
              ...
              $sqlCnt = "SELECT count(*) CNT  FROM WORK_CORE.EXEC_MANAG_OBJECTS WHERE ID_EM_GROUP = $IdEmGroup AND enable='Y'";
              $stmtCnt = db2_prepare($conn, $sqlCnt);
              $resultCnt = db2_execute($stmtCnt);
              while ($rowCnt = db2_fetch_assoc($stmtCnt)) {
                $CntDep = $rowCnt['CNT'];
 ...
 <li <?php echo $lidisable; ?>>
         ...
         <td>
           <table class="ExcelTable">
                        ...
                        ?><img class="FolderImg" src="./images/StatusI.png"><?php
                                                                          ...
                                                                          if ("$Status" != "I") {
                                                                            ?><img class="FolderImg" src="./images/Status<?php echo "$Status"; ?>.png"><?php
                                                                                                ...
                                                                                                if ("$NotEnable" != "0") {
                                                                                                  ?><img class="FolderImg" src="./images/Attention.png"><?php
                                                                                                  $DescNotEnable = "<font color='red'> ${NotEnable}Off</font>";
                                                                                                }
                                                                              ?>
                       <div class="GroupNameGroup" onclick="OpenGroup(<?php echo $IdEmGroup; ?>,'<?php echo $NameGroup; ?>')" title="<?php echo $IdEmGroup; ?>"><?php echo "$NameGroup [$CntDep${DescNotEnable}]"; ?></div>
                     </td>
                   </tr>
                   <tr>
                     <td>
                       <div class="GroupNameGroupDir"><B>Creator:</B> <?php echo "$Creator - $TimeCreator"; ?></div>
                     </td>
                   </tr>
                   <tr>
                     <td>
             ...
             <tr>
               ...
               <?php } ?>
               <td>
                 <div width="100px"><?php echo "$DescrGroup"; ?></div>
               </td>
               <th>End Time</th>
   ...
   <?php
    ...
    ?><div class="P<?php echo $IdEmGroup; ?>" hidden><?php
                                                        ...
                                                        $sqlCnt = "SELECT count(*) CNT  FROM WORK_CORE.EXEC_MANAG_OBJECTS WHERE ID_EM_GROUP = $IdEmGroupDep AND ENABLE ='Y'";
                                                        $stmtCnt = db2_prepare($conn, $sqlCnt);
                                                        $resultCnt = db2_execute($stmtCnt);
                                                        while ($rowCnt = db2_fetch_assoc($stmtCnt)) {
                                                          $CntDep = $rowCnt['CNT'];
               ...
               <td>
                 <table class="ExcelTable" style="background:white;">
                              ...
                              ?><img class="FolderImg" src="./images/StatusI.png"><?php
                                                                              ...
                                                                              if ("$DepStatus" != "I") {
                                                                                ?><img class="FolderImg" src="./images/Status<?php echo "$DepStatus"; ?>.png"><?php
                                                                                                        ...
                                                                                                        if ("$DepNotEnable" != "0") {
                                                                                                          ?><img class="FolderImg" src="./images/Attention.png"><?php
                                                                                                          $DescNotEnable = "<font color='red'> ${DepNotEnable}Off</font>";
                                                                                                        }
                                                                                  ?>
                             <div class="GroupNameGroup" onclick="OpenGroup(<?php echo $IdEmGroupDep; ?>,'<?php echo $DepNameGroup; ?>')" title="<?php echo $IdEmGroupDep; ?>"><?php echo "$DepNameGroup [$CntDep$DescNotEnable]"; ?></div>
                           </td>
                         </tr>
                         <tr>
                           <td>
                             <div class="GroupNameGroupDir"><B>Creator:</B> <?php echo "$DepCreator - $TimeCreator"; ?></div>
                           </td>
                         </tr>
                         <tr>
                           <td>
                   ...
                   <tr>
                     ...
                     <?php } ?>
                     <td>
                       <div width="100px"><?php echo "$DepDescrGroup"; ?></div>
                     </td>
                     <th>End Time</th>
 ...
 <button id="ShowCodaExec" onclick="OpenCoda();return false;" class="Button btn"><i class="fa-brands fa-firstdraft"> </i> IN CODA</button>
 <button id="PulMostraStorico" onclick="mostraStorico();return false;" class="Button btn"><i class="fa-solid fa-box-archive"> </i> STORICO</button>
 ...
 <script>
   ...
   function mostraStorico() {
     ...
     $.ajax({
       ...
       url: 'index.php?controller=execmanag&action=mostrastorico',
       ...
       success: function(risposta) {
         ...
         $("#Filedialog").dialog({
           title: 'STORICO ULTIMI 60 GIORNI'
         });
   ...
   function OpenCoda() {
     ...
     $.ajax({
       ...
       // specifico la URL della risorsa da contattare
       //url: './PHP/ExecManag_MostraStorico.php',
       url: 'index.php?controller=execmanag&action=codaexec',
       // imposto l'azione in caso di successo
       success: function(risposta) {
   ...
   function getParameterByName(name) {
     // Ottieni la stringa di query dell'URL
   ...
   function OpenGroup(vIdEmGroup, vNameGroup) {
     ...
     var input = $("<input>")
       ...
       .val(vNameGroup);
     $('#FormScheduler').append($(input));
     var sitoValue = getParameterByName('sito');
     $('#FormScheduler').attr('action', './index.php?sito=' + sitoValue + '&controller=execmanag&action=ExecManag')
