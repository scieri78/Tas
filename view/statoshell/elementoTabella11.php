<li id="<?php echo $Rt_ROUTINE; ?>">
     ...
     <a id="<?php echo $Rt_ROUTINE; ?>">
          <table class="ExcelTable L3Schema Tabella11" style="box-shadow: 0px 0px 0px 1px black; height:35px;">
               <tr>
                    <th class="<?php echo $RtEsito; ?>" style="width:8px;"></th>
                    <th class="openLi" style="<?php echo $cursor; ?>"><b>schema</b></th>
                    <td class="openLi" style="<?php echo $cursor; ?>"><?php echo $Rt_SCHEMA; ?></td>
                    <?php if ($Rt_PACKAGE != "") { ?>
                         <th class="openLi"><b>package</b></th>
                         <td class="openLi"><?php echo $Rt_PACKAGE; ?></td>
                         <td>
     ...
     <?php
     if ($Rt_CNT_SON != "0") {
          SearchSonRoutine($conn, $datishell->ListIdOpen, $IdRunSql, $IdRunSh, $Rt_FATHER, $Status, $_modelshell);
     }
     ?>
</li>