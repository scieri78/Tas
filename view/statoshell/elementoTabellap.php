 <?php
  $titolo = '<B>' . $ShName . '</B>';
  $iconStatus = '<img title="' . $IdRunSh . '" src="./images/Shell.png" class="IconFile"  onclick="OpenShSel(' . $IdRunSh . ');" />';
  ...
  $iconAction .= '<img src="./images/PlsqlTab.png" onclick="openRelTab(\'' . $IdSh . '\',\'' . $IdRunSh . '\',\'\',\'' . $ShName . '\')" class="IconSh" style="width:25px;">';
  if ($ShLog != "") {
 ...
 <a onclick="ChangeA<?php echo $datishell->InRetePasso; ?>('<?php echo $IdRunSh; ?>')">
   <table class="ExcelTable L0Def Tabella1" style="box-shadow: 0px 0px 0px 1px black;">
     <tr>
       ...
       <td class="openLi" rowspan=2 style="min-width:50px" title='<?php echo $ShMessage; ?>'>RC:<?php echo $ShRc; ?></td>
       <td rowspan=2 class="openLi" style="cursor:pointer;min-width:280px">
         <?php echo $titolo; ?>
       </td>
