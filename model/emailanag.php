...
class emailanag_model
	{
		...
		public function AddMail($AddName,$AddUsername,$AddMail)
		{
			try
			{	
		...
		public function updateShell($NAME,$USERNAME,$MAIL,$ID_MAIL_ANAG)
		{
			try
			{
					$sql = "update 
					 ".$this->strTableSpace.$this->tableName."
					SET NAME=?,USERNAME=?,MAIL=?
					WHERE ID_MAIL_ANAG = ?
					";
                $res = $this->_db->updateDb($sql,[$NAME,$USERNAME,$MAIL,$ID_MAIL_ANAG]);	
